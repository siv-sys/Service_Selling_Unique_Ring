-- =====================================================
-- UserPair Database Schema for RingOS Platform
-- Database: ring_app
-- Tables: 10 tables for pair management
-- =====================================================
...
-- Tables created:
--   1. user_pairs - Main pair information
--   2. pair_members - User to pair associations
--   3. pair_invitations - Invitation management
--   4. pair_activities - Activity logging
--   5. pair_sync_logs - Synchronization history
--   6. pair_preferences - Pair settings
--   7. pair_messages - Direct messaging
--   8. pair_proximity_events - Proximity detection
--   9. pair_connection_history - Connection quality
--   10. pair_anniversaries - Special dates
-- =====================================================
