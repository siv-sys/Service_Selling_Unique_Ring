...
export function AuthLayout({ children, image, title, subtitle }: AuthLayoutProps) {
  return (
    <div className="flex h-screen w-full overflow-hidden bg-white dark:bg-slate-950 dark:text-slate-100">
      {/* Left Panel: Image */}
      ...
      {/* Right Panel: Content */}
      <div className="flex h-full w-full flex-col justify-center bg-white px-5 py-5 md:px-10 md:py-6 dark:bg-slate-950 lg:w-1/2 lg:px-16 lg:py-8">
