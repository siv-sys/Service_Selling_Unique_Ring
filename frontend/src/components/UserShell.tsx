  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-charcoal dark:text-white">
      ...
      <style>{`
        ...
        .dark .user-shell-content .text-slate-950,
        .dark .user-shell-content .text-slate-800,
        .dark .user-shell-content .text-gray-900,
        .dark .user-shell-content .text-gray-800,
        .dark .user-shell-content .text-black,
        .dark .user-shell-content .dark\\:text-black {
          color: #f8fafc !important;
        }

        .dark .user-shell-content .text-slate-300,
        ...
        .dark .user-shell-content .text-gray-700,
        .dark .user-shell-content .text-gray-600,
        .dark .user-shell-content .text-gray-500,
        .dark .user-shell-content .text-gray-400,
        .dark .user-shell-content .text-cream\\/70,
        .dark .user-shell-content .text-cream\\/60,
        .dark .user-shell-content .text-charcoal\\/60,
        .dark .user-shell-content .dark\\:text-slate-500 {
          color: #cbd5e1 !important;
        }

        .dark .user-shell-content .text-slate-200,
        .dark .user-shell-content .text-gray-300,
        .dark .user-shell-content .text-cream {
          color: #e2e8f0 !important;
        }

        .dark .user-shell-content h1,
        .dark .user-shell-content h2,
        .dark .user-shell-content h3,
        .dark .user-shell-content h4,
        .dark .user-shell-content strong,
        .dark .user-shell-content label {
          color: #f8fafc;
        }

        .dark .user-shell-content ::placeholder {
          color: #94a3b8;
          opacity: 1;
        }
        ...
        .dark .user-shell-content option {
          background-color: #020617;
          color: #f8fafc;
        }
