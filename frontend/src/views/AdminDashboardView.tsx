...
const AdminDashboardView = () => {
  ...
  return (
    <>
      <style>{`
        .dark .admin-dashboard-page .bg-white {
          background-color: #111827 !important;
        }

        .dark .admin-dashboard-page .border-pink-300,
        ...
        .dark .admin-dashboard-page .bg-pink-100,
        .dark .admin-dashboard-page .bg-slate-50,
        .dark .admin-dashboard-page .bg-slate-100,
        .dark .admin-dashboard-page .bg-slate-200 {
      ...
      <main className="admin-dashboard-page flex-1 overflow-y-auto p-8 space-y-8">
