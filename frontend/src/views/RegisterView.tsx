  ...
  return (
    ...
    >
      <div className="mb-5 flex flex-col items-start">
        <h2 className="mb-1 text-3xl font-bold text-slate-900 dark:text-slate-100">Create Account</h2>
        <p className="text-sm text-slate-500 dark:text-slate-400">Please fill in your details to get started.</p>
      </div>
