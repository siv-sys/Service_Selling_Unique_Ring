      ...
      <main className="flex-1 overflow-y-auto p-8">
        <div className="max-w-5xl mx-auto space-y-6">
          <section className="bg-white rounded-3xl border border-pink-200 shadow-sm p-6 md:p-8">
            <h3 className="text-xl font-bold text-slate-900">Seed Default Catalog Data</h3>
          ...
          >
            <h4 className="text-lg font-bold text-slate-900">Insert Custom Catalog Data</h4>
          ...
          {errorMessage && (
            <div className="px-4 py-4 rounded-xl bg-rose-50 text-rose-700 text-sm font-semibold border border-rose-100">
              {errorMessage}
            </div>
          )}
        </div>
