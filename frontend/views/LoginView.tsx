    ...
    >
      <div className="mb-5 flex flex-col items-start">
        <div className="mb-4 flex items-center gap-2">
          ...
          <span className="text-lg font-bold tracking-tight text-slate-900 dark:text-slate-100">Unique Ring</span>
        </div>
        <h2 className="mb-1 text-3xl font-bold text-slate-900 dark:text-slate-100">Sign In</h2>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="remember" className="cursor-pointer text-xs font-semibold text-slate-600 dark:text-slate-300">
      ...
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-white px-4 font-medium text-slate-500 dark:bg-slate-950 dark:text-slate-400">Or continue with</span>
        </div>
      </div>
