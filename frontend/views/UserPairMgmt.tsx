  ...
  <tr className={`hover:bg-primary/5 transition-colors group ${disabled ? 'bg-slate-50/30' : ''}`}>
    ...
    <td className="p-5">
      <span className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase border ${
        ...
        tier === 'Standard' ? 'text-slate-700 bg-slate-100 border-slate-200' :
    ...
    <td className="p-5 text-right">
      <div className="flex items-center justify-end gap-1">
        <button className="h-8 px-3 rounded-md bg-primary text-white text-xs font-bold inline-flex items-center gap-1 hover:bg-primary-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 transition-colors">
          <Edit3 className="w-3.5 h-3.5" />
          Edit
        </button>
        <button className="p-1.5 text-slate-600 hover:text-primary hover:bg-primary/5 rounded transition-colors"><Eye className="w-4 h-4" /></button>
        <button className="p-1.5 text-slate-600 hover:text-primary hover:bg-primary/5 rounded transition-colors"><BarChart2 className="w-4 h-4" /></button>
        <button className="p-1.5 text-slate-600 hover:text-primary hover:bg-primary/5 rounded transition-colors"><Link className="w-4 h-4" /></button>
        <button className="p-1.5 text-slate-600 hover:text-red-700 hover:bg-red-50 rounded transition-colors"><Trash2 className="w-4 h-4" /></button>
      </div>
    </td>
  </tr>
);
